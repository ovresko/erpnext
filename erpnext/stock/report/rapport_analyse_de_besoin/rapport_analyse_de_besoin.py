...
def execute(filters=None):
	...
	for mri in items:
		...
		row = ["<button id='%s' onClick='demander_item(this.getAttribute("data"))' type='button'>Demander</button><input placeholder='Qts' id='input_%s'></input>" % (mri.item_code,mri.item_code),
		       mri.item_code,
		       mri.item_name,
		       mri.manufacturer,
