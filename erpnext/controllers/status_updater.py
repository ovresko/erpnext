...
status_map = {
	...
	"Purchase Order": [
		...
		["To Receive", "eval:self.per_received == 0 and self.per_billed == 100 and self.docstatus == 1"],
		["Reliquat", "eval:self.per_billed < 100 and self.per_billed > 0 and self.docstatus == 1"],
		["Completed", "eval:self.per_received == 100 and self.per_billed == 100 and self.docstatus == 1"],
		["To Return", "eval:self.per_received < 100 and self.per_received > 0 and self.per_billed == 100 and self.docstatus == 1"],
