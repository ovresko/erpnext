...
class POSItems {
	...
	get_item_html(item) {
		...
		if(item.actual_qty){
			...
			actual_qty = '<span class="strong" style="color:1810E6">Qts: '+item.actual_qty+'</span>   <button data-item-code="'+item.item_code+'" data-label="stock" class="btn btn-success btn-xs btn-stock" style="margin-right: 5px;"><i class="fa fa-cubes"></i></button>';
