	...
	make_dom() {
		this.wrapper.html(`
			<div class="vehicule-name-wrapper" style="display:flex;background-color:#F0FBFA;border-radius:20px">
				...
				<div style="width:50% ">					
				<span class="strong">Marque</span> : <span class="vehicule-marque-name clearfix"></span> 
				<span class="strong">Modele</span> : <span class="vehicule-modele-name clearfix"></span>
				<span class="strong">Generation</span> : <span class="vehicule-generation-name clearfix"></span> 
				<span class="strong">Version</span> : <span class="vehicule-version-name clearfix"></span> 
				</div>
