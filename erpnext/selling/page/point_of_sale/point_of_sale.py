...
def get_conditions(item_code, serial_no, batch_no, barcode):
	...
	condition = """ ( i.clean_manufacturer_part_number = '{}' or i.clean_manufacturer_part_number LIKE '%%{}%%' or  i.manufacturer_part_no = '{}' or  i.manufacturer_part_no LIKE '%%{}%%' or i.oem_text = '{}'  or i.oem_text LIKE '%%{}%%' or MATCH(i.nom_generique_long) AGAINST('({}) ({})' IN NATURAL LANGUAGE MODE)  )""".format(item_code,item_code,item_code,item_code,item_code,item_code,keyword,item_code)
